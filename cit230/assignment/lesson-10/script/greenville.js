function getWeather() {
    ...
    weather.open('GET', 'http://api.openweathermap.org/data/2.5/weather?zip=29607&appid=8cb5964f64377624cd1b16ef747fa82f&units=imperial', true);
    weather.send();

    weather.onload = function () {
        var weathercondition = JSON.parse(weather.responseText);

        document.getElementById('cityname').innerHTML = 'Greenville, ' + weathercondition.name;
    ...
    /*var weather = new XMLHttpRequest();
    weather.open('GET', 'https://api.wunderground.com/api/9d9d50d9dae82d0f/conditions/q/NC/greenville.json', true);
    weather.send();
    ...
    */
    ...
    forecast.open('GET', 'https://api.wunderground.com/api/9d9d50d9dae82d0f/forecast10day/q/NC/greenville.json', true);
    forecast.send();
